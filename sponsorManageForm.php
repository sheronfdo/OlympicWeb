                                    ...
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php
                                               $db = new dbConnect();
                                               $result = $db->getfromdb("SELECT id,description,srcLink,imageName,shownLocation FROM sponsoredcontent where status='1'");
                                                ...
                                                if ($row = mysqli_num_rows($result)) {
                                                    ...
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo '<td>' . $row['srcLink'] . '</td>';
                                                        echo '<td>' . $row['imageName'] . '</td>';
                                                        echo '<td>' . $row['shownLocation'] . '</td>'; 
                                                        ?>
                                                    ...
                                                    <td>
                                                        <?php
                                                            ...
                                                            echo '<a href="deleteSponsor.php?sponsorid='.$row['id'].'"><button type="button" class="btn btn-block bg-gradient-danger btn-sm">Remove</button></a>';
