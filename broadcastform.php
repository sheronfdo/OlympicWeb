        ...
        <div class="col-11 col-xxl-5 col-xl-6 col-lg-7 col-md-8 col-sm-10 news-form">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Add Broadcast</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form action="broadcastform.php" method="POST">
                    ...
                    <?php 
                        $db = new dbConnect();
                        $result = $db->getfromdb("SELECT id,overview FROM event");
                        ...
                        <select name="eventId" class="form-select" aria-label="Default select example">
                            ...
                            <?php 
                              foreach ($options as $option) {
                                ?>
                             <option value="<?php echo $option['id'];?>" name="event" ><?php echo $option['id']." - ".$option['overview']; ?> </option>
                            <?php 
                            }
                        ?>
                        </select>
                    ...
                    <div class="card-footer">
                        <button type="submit" name="broadcast_submit" class="btn btn-primary">Submit</button>
                    </div>
                </form>
            </div>
        </div>
